...
dbWriteTable(mydb,"nyc_1",nyc_1,overwrite=T)
dbWriteTable(mydb,"nyc_full",nyc_full,overwrite=T)
dbWriteTable(mydb,"nyc_s1",nyc_s1,overwrite=T)
dbWriteTable(mydb,"nyc_s12",nyc_s12,overwrite=T)
dbWriteTable(mydb,"nyc_s2",nyc_s2,overwrite=T)
dbWriteTable(mydb,"trulia",trulia,overwrite=T)
dbWriteTable(mydb,"zip_pop",zip_pop,overwrite=T)
dbDisconnect(mydb)
```
