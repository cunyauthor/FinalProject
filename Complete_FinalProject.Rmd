...
The data were obtained from two sources. Crime data were collected from New York City Police Department complaint data. The crime dataset includes all valid felony, misdemeanor, and violation crimes reported to the New York City Police Department (NYPD) from 2006 to the end of last year (2015). These data represent criminal offenses according to New York State Penal Law definitions, not FBI Uniform Crime Report definitions, and are therefore not comparable to UCR reported crime.
...
Property value data were scraped from the real estate listing site Zillow. 
...
The resulting dataset was randomized to create to create a sample of approximately 10,000 cases. The sample was broken into 5 smaller samples in order to use Google API to match longitude and latitude in the data to street addresses.
