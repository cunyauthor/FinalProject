...
nyc1 <- dbSendQuery(connection," CREATE TABLE nyc_1
(
...
nycFull <- dbSendQuery(connection, "CREATE TABLE nyc_full
(
...
nycs1 <- dbSendQuery(connection, "CREATE TABLE nyc_s1
(
`zip` varchar(100) NOT NULL,
`freq_crime` varchar(100) NOT NULL
...
nycs12 <- dbSendQuery(connection, "CREATE TABLE nyc_s12
(
`zip` varchar(100) NOT NULL,
`freq_crime` varchar(100) NOT NULL,
`freq_violent_crime` varchar(100) NOT NULL
...
nycs2 <- dbSendQuery(connection, "CREATE TABLE nyc_s2
(
`zip` varchar(100) NOT NULL,
`freq_violent_crime` varchar(100) NOT NULL
...
truliaSQL <- dbSendQuery(connection, "CREATE TABLE trulia
(
...
```{r}
<iframe 
src="https://public.tableau.com/profile/ka.man.chan#!/"
